...
#The historgram depicts the amount of houses at a certain price range.
#As indicated by the histogram the more expensive the houses are, the fewer of them are present.
#Primiarily we see houses in the 0-1.000.000 range.
